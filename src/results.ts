...
const rounds = [
    new RoundInfo2024('ГП Бахрэйну', "ГП Австралії", "au", 29, 2),
    new RoundInfo2024('ГП Саўдаўскай Аравіі', "ГП Австралії", "au", 7, 3),
    ...
    new RoundInfo2024("ГП Манака", "ГП Монако", "it", 24, 5),
    new RoundInfo2024("ГП Канады", "ГП Канади", "it", 7, 6),
    new RoundInfo2024("ГП Гішпаніі", "ГП Іспанії", "it", 21, 6),
    new RoundInfo2024("ГП Аўстрыі", "ГП Австрії", "it", 28, 6),
    new RoundInfo2024("ГП Вялікай Брытаніі", "ГП Великої Британії", "it", 5, 7),
    new RoundInfo2024("ГП Вугоршчыны", "ГП Угорщини", "it", 19, 7),
    new RoundInfo2024("ГП Бельгіі", "ГП Бельгії", "it", 26, 7),
    new RoundInfo2024("ГП Нідэрландаў", "ГП Нідерландів", "it", 23, 8),
    new RoundInfo2024("ГП Італіі", "ГП Італії", "it", 30, 8),
    new RoundInfo2024("ГП Азербайджану", "ГП Азербайджану", "it", 13, 9),
    new RoundInfo2024("ГП Сінгапуру", "ГП Сінгапуру", "it", 20, 9),
    new RoundInfo2024("ГП ЗША", "ГП США", "it", 18, 10),
    new RoundInfo2024("ГП Мексікі", "ГП Мексики", "it", 25, 10),
    new RoundInfo2024("ГП Бразіліі", "ГП Бразилії", "it", 1, 11),
    new RoundInfo2024("ГП Лас-Вегаса", "ГП Лас-Вегаса", "it", 21, 11),
    new RoundInfo2024("ГП Катару", "ГП Катару", "it", 29, 11),
    new RoundInfo2024("ГП Абу-Дабі", "ГП Абу-Дабі", "it", 6, 12),
]
